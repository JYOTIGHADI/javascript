...
async function fetchData() {
  ...
  const user2 = {
    name: "Jyoti",
    greet: function () {
      const sayHello = () => console.log(this.name); // ✅ "Jyoti"
      sayHello();
    },
  };
  ...
  const user3 = new personData("Jyoti");
  ...
  const anotherPerson1 = { name: "rohit" };
  
  person1.greet.call(anotherPerson1, 20);
  ...
  const anotherPerson2 = { name: "rohit" };
  
  person2.greet.apply(anotherPerson2, [20, "Pen"]);
  ...
  const anotherPerson3 = { name: "rohit" };
  
  const newGreet = person3.greet.bind(anotherPerson3, 20);
